...
describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    it('a blog can be created', function() {
      ...
      cy.get('#create').click()
      cy
        .contains('a new blog Uusi blogi is added')
        .should('have.css', 'color', 'rgb(0, 128, 0)')
      cy.contains('Uusi blogi by Blogin kirjoittaja')
    })

    it('a blog can be liked', function() {
      cy.createBlog({ title: 'Uusi blogi', author: 'Blogin kirjoittaja', url: 'www.bloggi.fi' })
      cy.contains('Uusi blogi by Blogin kirjoittaja')
      cy.get('#view').click()
      cy.contains('likes 0')
      cy.get('#like').click()
    ...
    it('blogs are ordered by most likes', function() {
      cy.createBlog({ title: 'Eka blogi', author: 'Blogin kirjoittaja', url: 'www.bloggi.fi' })
      cy.get('#view').click()
      cy.get('#like').click()
      cy.contains('likes 1')
      cy.get('#like').click()
      ...
      cy.createBlog({ title: 'Tykätyin blogi', author: 'Blogin kirjoittaja', url: 'www.plokki.fi' })
